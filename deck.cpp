...
Deck::Deck(){
 ...
 skill[0].setThis(16, "ród³o Many", 1, 0, 'd', "media/cute_image.png");
 skill[1].setThis(17, "Moc ród³a", 1, 0, 'd', "media/cute_image.png");
 skill[2].setThis(18, "Astralna Energia", 1, 0, 'd', "media/cute_image.png");
 skill[3].setThis(19, "Nierealna Potêga", 1, 0, 'd', "media/cute_image.png");
